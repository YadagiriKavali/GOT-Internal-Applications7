...
namespace meseva.MesevaService {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://TG.org/", ConfigurationName="MesevaService.MeesevaMobileWebserviceSoap")]
    public interface MeesevaMobileWebserviceSoap {
        ...
        string GetIssueOfOccupancyRightScertForINAMLANDSTransactionNo(
                    ...
                    string TotalAmount, 
                    string Doc_Applicationform, 
                    string Doc_1954_1955_kasara_pahani, 
                    string Doc_73_74_latest_pahani_copies, 
                    string Doc_Family_Tree, 
                    string Doc_Relationship_with_Inamdhar);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://TG.org/GetCCDocDistrict_New", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Data.DataSet GetCCDocDistrict_New(string UserID, string Password);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string GetCCGetDocYear(string UserID, string Password, int SROCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://TG.org/GetCCGetDocList", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string GetCCGetDocList(string UserID, string Password, int SROCode, int SROYear);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string GHMCBirthOrDeathSearchRecord(string UserID, string Password, string Service_Id, string ServiceType, string DateOfBirth, string RegistrationNo, string CircleNo, string Gender, string MotherName, string FatherHusbandName, string DeceasedName);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string GHMCSearchDeathRecord(string UserID, string Password, string Service_Id, string ServiceType, string DateOfBirth, string RegistrationNo, string CircleNo, string Gender, string DeceasedName, string FatherName);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        meseva.MesevaService.CCGetDocFileResponse CCGetDocFile(meseva.MesevaService.CCGetDocFileRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string GetAdangalTransactionNo_old(meseva.MesevaService.AdangalTrans obj, string userId, string password, string LogindID, string ApplicationNo);
        ...
        string GetCommunityDateofBirthTransactionNo(
                    ...
                    string Doc_IDProof, 
                    string Doc_DOB_Cert, 
                    string Doc_SSC_Marks_Memo, 
                    string Doc_Immovable_Properties, 
                    string Doc_study_Cert);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface MeesevaMobileWebserviceSoapChannel : meseva.MesevaService.MeesevaMobileWebserviceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MeesevaMobileWebserviceSoapClient : System.ServiceModel.ClientBase<meseva.MesevaService.MeesevaMobileWebserviceSoap>, meseva.MesevaService.MeesevaMobileWebserviceSoap {
        ...
        public System.Data.DataSet GetCCDocDistrict_New(string UserID, string Password) {
            return base.Channel.GetCCDocDistrict_New(UserID, Password);
        }
        ...
        public string GetCCGetDocYear(string UserID, string Password, int SROCode) {
            return base.Channel.GetCCGetDocYear(UserID, Password, SROCode);
        }
        
        public string GetCCGetDocList(string UserID, string Password, int SROCode, int SROYear) {
        ...
        public string GetCertifiedCopyOfRegistrationDocumentTransactionNo(
                    ...
                    string Courier_Charge, 
                    string Final_Amount) {
            return base.Channel.GetCertifiedCopyOfRegistrationDocumentTransactionNo(UserId, Password, LogindID, ServiceID, Doc_District, SRO_Code, Year_of_Registration, Document_id, ApplicationNumber, ApplicantName, DoorNo, Permanent_District, Permanent_Mandal, Permanent_Village, PinCode, MobileNo, Email, Chalan_Amount, User_Charge, Courier_Charge, Final_Amount);
        }
        ...
        public string GHMCBirthOrDeathSearchRecord(string UserID, string Password, string Service_Id, string ServiceType, string DateOfBirth, string RegistrationNo, string CircleNo, string Gender, string MotherName, string FatherHusbandName, string DeceasedName) {
            return base.Channel.GHMCBirthOrDeathSearchRecord(UserID, Password, Service_Id, ServiceType, DateOfBirth, RegistrationNo, CircleNo, Gender, MotherName, FatherHusbandName, DeceasedName);
        }
        ...
        public string GetGHMCNonAailabilityBirthDeathTransactionNo(
                    ...
                    string OtherDoc, 
                    string Medicallegal) {
            return base.Channel.GetGHMCNonAailabilityBirthDeathTransactionNo(UserId, Password, LoginID, Service_Id, Service_Type, ApplicationNumber, AadharCardNo, ApplicantName, ApplicantFatherName, Age, Address, MobileNumber, EventRelation, RationCardNumber, EmailID, EventName, DateofEvent, PlaceofEvent, DeathCause, ResidenceAddress, EventGender, MotherName, FatherName, Circle, Ward, Delivery_Type, Postal_DoorNo, Postal_District, Postal_Mandal, Postal_Village, Postal_Pincode, NumberOfCopies, Purpose, Service_Charge, Postal_Charge, User_Charge, Total_Amount, PhysicalDocument, RationOtherResidenceProof, SchoolBonafied, SSCMark, Deathnotarized, Otherevidence, Affidavit, OtherDoc, Medicallegal);
        }
        ...
        public string GHMCSearchDeathRecord(string UserID, string Password, string Service_Id, string ServiceType, string DateOfBirth, string RegistrationNo, string CircleNo, string Gender, string DeceasedName, string FatherName) {
            return base.Channel.GHMCSearchDeathRecord(UserID, Password, Service_Id, ServiceType, DateOfBirth, RegistrationNo, CircleNo, Gender, DeceasedName, FatherName);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        meseva.MesevaService.CCGetDocFileResponse meseva.MesevaService.MeesevaMobileWebserviceSoap.CCGetDocFile(meseva.MesevaService.CCGetDocFileRequest request) {
            return base.Channel.CCGetDocFile(request);
        }
        
        public byte[] CCGetDocFile(string docId, string year, string sro) {
            meseva.MesevaService.CCGetDocFileRequest inValue = new meseva.MesevaService.CCGetDocFileRequest();
            inValue.docId = docId;
            inValue.year = year;
            inValue.sro = sro;
            meseva.MesevaService.CCGetDocFileResponse retVal = ((meseva.MesevaService.MeesevaMobileWebserviceSoap)(this)).CCGetDocFile(inValue);
        ...
        public string GetAdangalTransactionNo_old(meseva.MesevaService.AdangalTrans obj, string userId, string password, string LogindID, string ApplicationNo) {
        ...
        public string GetSevaBookingTransactionNo(
                    ...
                    string Doc_IDProof, 
                    string Doc_Photo) {
            return base.Channel.GetSevaBookingTransactionNo(UserId, Password, LogindID, ServiceID, TempleID, Sevaid, BatchID, SevabookingDate, ApplicationNo, AadharCardNo, DevoteeName, Nakshatram, Gothram, Gender, Age, HouseNo, Location, MobileNumber, EmailId, CountryId, StateId, District, Mandal, Village, Pincode, StateName, DistrictName, MandalName, VillageName, ProofDocumentID, ProofDocumentNumber, ProofDocumentName, DeliveryType, SevaAmount, Usercharges, TotalAmount, ApplicantName, RelationId, Doc_Applicationform, Doc_IDProof, Doc_Photo);
        }
        ...
        public string GetSriLaxmiNarasimhaSwamiwariDevastanamSevaBookingTransactionNo(
                    ...
                    string Doc_Applicationform, 
                    string Doc_IDProof) {
            return base.Channel.GetSriLaxmiNarasimhaSwamiwariDevastanamSevaBookingTransactionNo(UserId, Password, LogindID, ServiceID, TempleID, Sevaid, BatchID, SevabookingDate, ApplicationNo, AadharCardNo, DevoteeName, Nakshatram, Gothram, Gender, Age, HouseNo, Location, MobileNumber, EmailId, CountryId, StateId, District, Mandal, Village, Pincode, StateName, DistrictName, MandalName, VillageName, ProofDocumentID, ProofDocumentNumber, ProofDocumentName, DeliveryType, SevaAmount, Usercharges, TotalAmount, ApplicantName, RelationId, Doc_Applicationform, Doc_IDProof);
        }
