...
namespace User
{
    public class clsPasswordFormat
    {
        ...
        public string GetPassword(string text)
        {
            ...
            try
            {
                ...
                if (_strPasswordType == string.Empty || _strPasswordType == "NORMAL")
                    paSSword = GetPassword(text, clsPasswordFormat.FORMATTYPE.NORMAL);
                else if (_strPasswordType == "HASH")
                    paSSword = GetPassword(text, clsPasswordFormat.FORMATTYPE.HASH);
                else if (_strPasswordType == "ENCRYPT")
                    paSSword = GetPassword(text, clsPasswordFormat.FORMATTYPE.ENCRYPT);
