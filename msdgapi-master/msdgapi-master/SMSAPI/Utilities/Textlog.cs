...
public static class TextLog
{
    ...
    {
        if (clsGeneral.GetConfigVal("ERRORLOG_INFO").ToUpper().GetBoolean())
    ...
    {
        if (clsGeneral.GetConfigVal("ERRORLOG_ERROR").ToUpper().GetBoolean())
    ...
    {
        if (clsGeneral.GetConfigVal("ERRORLOG_DEBUG").ToUpper().GetBoolean())
    ...
    {
        if (clsGeneral.GetConfigVal("ERRORLOG_AUDIT").ToUpper().GetBoolean())
